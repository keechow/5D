...
counter = 24
while counter >= 0:
    for each in i12_TOP3_top50_digit_count:
        print counter, each
    counter -=1
"""
print "\nLen result_24m_combined: ", len(result_24m_combined)
print "\nLen result_12m_combined: ", len(result_12m_combined)
print "\nLen result_6m_combined: ", len(result_6m_combined) 
print "\nLen result_3m_combined: ", len(result_3m_combined)
print "\nLen result_1m_combined: ", len(result_1m_combined)
print
print
print "\nLen i12_24m: ", len(i12_24m)
print "\nLen i12_12m: ", len(i12_12m)
print "\nLen i12_6m: ", len(i12_6m)
print "\nLen i12_3m: ", len(i12_3m) 
print "\nLen i12_1m: ", len(i12_1m)
print
print
print "\nLen i12_24m_TOP3: ", len(i12_24m_TOP3)
print "\nLen i12_12m_TOP3: ", len(i12_12m_TOP3)
print "\nLen i12_6m_TOP3: ", len(i12_6m_TOP3)
print "\nLen i12_3m_TOP3: ", len(i12_3m_TOP3)
print "\nLen i12_1m_TOP3: ", len(i12_1m_TOP3)
"""
