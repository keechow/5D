"""
Name:       parsing_module4.py
Objective:  Same with parsing_module.py but date range entered as params.
            This can be use to code in specified date range without asking user to enter date range
            Return a list containing 4D numbers and its occurrences according to prize category
...
def get_data(start, end):
    ...
    start_year = "startyear=" + start[:4] + "&"
    start_month = "startmonth=" + start[5:7] + "&"
    start_day = "startday=" + start[8:] + "&"
    end_year = "endyear=" + end[:4] + "&"
    end_month = "endmonth=" + end[5:7] + "&"
    end_day = "endday=" + end[8:]
