...
def get_data(month, date):
    ...
    start_month = "startmonth=" + str_month + "&"
    start_day = "startday=" + str_date + "&"
    end_year = "endyear=2015" + "&"
    end_month = "endmonth=" + str_month + "&"
    end_day = "endday=" + str_date
